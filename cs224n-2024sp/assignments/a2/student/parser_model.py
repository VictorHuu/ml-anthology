...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        ###     nn.Parameter: https://docs.pytorch.org/docs/stable/generated/torch.nn.parameter.Parameter.html#torch.nn.parameter.Parameter
        ###     Initialization: https://pytorch.org/docs/stable/nn.init.html
        ###     Dropout: https://pytorch.org/docs/stable/nn.html#dropout-layers
        ### 
        ### See the PDF for hints.
        self.embed_to_hidden_weight = nn.Parameter(torch.empty(self.n_features*embeddings.shape[1],hidden_size))
    ...
    def embedding_lookup(self, w):
        ...
        w_flat = w.reshape(-1)
        x = torch.index_select(self.embeddings,0,w_flat)
